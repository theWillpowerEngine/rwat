...
const makeWorldMap = require("./worldMap")
const colors = require("../map/colors")
const tiles = require('../map/tiles')
const renderModes = require("./renderModes")

module.exports = (eng) => {
    let engine = eng
    engine.lights = makeLights(engine)
    var that = {
        mode: renderModes.localMap,
        
        worldMap: makeWorldMap(engine),
